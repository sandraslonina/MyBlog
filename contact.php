...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        try {
            ...
            $mail->addAddress('sandra.slonina95@gmail.com');
...
<?php else: ?>
    ...
    <form method="post" id="formContact">
        ...
        <div class="form-group mb-3">
            <label for="subject"><i class="fa-sharp fa-solid fa-star-of-life"></i> Subject</label>
        ...
        <button class="btn btn-outline-warning signButton btn-lg"><i class="fa-solid fa-paper-plane"></i> Send</button>
