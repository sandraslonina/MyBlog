...
<?php if ($article->image_file) : ?>
    ...
    <a class="delete btn btn-outline-danger signButton" href="delete-article-image.php?id=<?= $article->id; ?>" role="button">Delete</a>
...
<form method="post" enctype="multipart/form-data">
    ...
    <button class="btn btn-outline-success signButton">Upload</button>
